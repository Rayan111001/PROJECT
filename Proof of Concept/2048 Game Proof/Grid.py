# Original template from https://www.geeksforgeeks.org/2048-game-in-python/
# Since been updated to use OOP.
...
class Grid:
	...
	# Specific moving. Returns whether the move resulted in a different grid.
